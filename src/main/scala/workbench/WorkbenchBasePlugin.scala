...
object WorkbenchBasePlugin extends AutoPlugin {
  ...
  object autoImport {
    ...
    val domainName = settingKey[String]("domainName")
    val previewDir = settingKey[String]("previewDir")
  }
  import autoImport._
  ...
  val workbenchSettings = Seq(
    ...
    server := new Server(localUrl.value._1, localUrl.value._2, domainName.value,previewDir.value),
